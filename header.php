<?php
    // base name will return the base name of the url like 
    // news-site/admin/post.php -> post.php
    include "config.php";
    ...
    switch($page){
        ...
        case "search.php":
            ...
            break;
        default:
            $page_title = "Online stationery Store";
            break;
    } 
?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                ?>
                <ul class='menu'>
                    <li><a class="<?php echo $active;?>" href='<?php echo $hostname ?>'>Home</a></li>
                    <?php
